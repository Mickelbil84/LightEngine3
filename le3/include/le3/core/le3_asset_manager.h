...
namespace le3 {
    ...
    const std::string DEFAULT_OBJECTPOSITIONS_SHADER = DEFAULT_ENGINE_PREFIX + "S_objectpositions";
    const std::string DEFAULT_OBJECTNORMALS_SHADER = DEFAULT_ENGINE_PREFIX + "S_objectnormals";
