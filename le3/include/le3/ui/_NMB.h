...
/*
* Comment (Jun 26th, 2026): This file was added directly to the project as the repository was removed from GitHub.
* It's a single header under the MIT license. See the copyright notice above. This header, besides this comment, is unmodified from the original source.
*/
