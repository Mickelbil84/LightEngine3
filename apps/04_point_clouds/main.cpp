...
public:
    ...
    void init() {
        ...
        LE3GetSceneManager().getScene("scene")->addFreeCamera("camera");
        LE3GetSceneManager().getScene("scene")->setBackgroundColor(glm::vec3(100.f/255.f, 149.f/255.f, 253.f/255.f));
    }
